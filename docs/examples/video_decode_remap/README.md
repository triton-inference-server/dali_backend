...
1. If you do not know yet what DALI is, please refer to [DALI's getting started guide](https://docs.nvidia.com/deeplearning/dali/main-user-guide/docs/examples/getting_started)
